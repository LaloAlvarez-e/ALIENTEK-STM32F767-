...
typedef enum
{
    ...
    SYSTICK_enPRI8 = (UBase_t) MCU_enPRI8,
    SYSTICK_enPRI9 = (UBase_t) MCU_enPRI9,
    SYSTICK_enPRI10 = (UBase_t) MCU_enPRI10,
    SYSTICK_enPRI11 = (UBase_t) MCU_enPRI11,
    SYSTICK_enPRI12 = (UBase_t) MCU_enPRI12,
    SYSTICK_enPRI13 = (UBase_t) MCU_enPRI13,
    SYSTICK_enPRI14 = (UBase_t) MCU_enPRI14,
    SYSTICK_enPRI15 = (UBase_t) MCU_enPRI15,
    SYSTICK_enPRIMAX = (UBase_t) MCU_enPRIMAX,
    SYSTICK_enDEFAULT = (UBase_t) MCU_enDEFAULT,
    SYSTICK_enPRI_UNDEF = (UBase_t) MCU_enDEFAULT,
}SYSTICK_nPRIORITY;
